...
async function displayProducts(baseURL, fileNames, productListId) {
    try {
        ...
        // / Controleer of het HTML-element is gevonden 
        if (!productList) {
        ...
        for (const fileName of fileNames) {
            ...
            products.forEach(product => {
                //controleerd of product voor mannen is en  Converteer de geslachtsaanduiding van het product naar kleine letters voor vergelijking
