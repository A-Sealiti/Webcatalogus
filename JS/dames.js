    ...
    try {
        ...
        for (const fileName of fileNames) {
            ...
            products.forEach(product => {
                //controleerd of product voor dames is en  Converteer de geslachtsaanduiding van het product naar kleine letters voor vergelijking
                if (product.gender.toLowerCase() === 'women') {
                    const card = document.createElement('li');
                    card.classList.add('card');
                     // aantal decimalen in een nummer te beperken
...
displayProducts(baseURL, newBalanceFiles, 'nikeList');
displayProducts(baseURL, adidasFiles, 'nikeList');
